...
import { AngularFirestore } from '@angular/fire/firestore'; //commicates with database
import { AngularFireStorage } from '@angular/fire/storage'; //communicates with our online bucket for file storage
